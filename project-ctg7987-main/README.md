...
I declare that I have read and completed the above checked item in the list: [Calvin Gutsa], [05 October 2024]
...
- *Concept #1*: [Inline Functions], *File name / Line numbers(s)*: [[MenuItem.h, lines 25-27]
- *Concept #2*: [Function Templates], *File name / Line numbers(s)*: [Order.cpp, lines 18-33]
- *Concept #3*: [Standard Template Library Vectors], *File name / Line numbers(s)*: [Restaurant.h, lines 28-35]
- *Concept #4*: [Friend Function], *File name / Line numbers(s)*: [MenuItem.h, line 28]
...
- *Concept #1*: [Classes and Objects], *File name / Line numbers(s)*: [main.cpp , line 20 ]
- *Concept #2*: [Inherintance], *File name / Line numbers(s)*: [Restaurant.h, lines 18-25]
- *Concept #3*: [Function Overloading], *File name / Line numbers(s)*: [Order.cpp, lines 23-48]
- *Concept #4*: [Error Handling], *File name / Line numbers(s)*: [Restaurant.cpp, lines 20, 46]
